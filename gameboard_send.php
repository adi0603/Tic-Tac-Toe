...
if (isset($_POST['play_again'])) {
  $result9 = mysqli_query($con,"Update game set turn='1',cell_1='0',cell_2='0',cell_3='0',cell_4='0',cell_5='0',cell_6='0',cell_7='0',cell_8='0',cell_9='0' where room_code='$room_code' and userid='$userid'");
}
...
<html>
    ...
    <body >          
        <center>
            <h2>Game Board - <span style="color: #ffcc00;;">Tic</span> <span style="color: #999999">Tac</span> <span style="color: #8080ff;">Toe</span></h2><br>
        ...
        <script type="text/javascript">
          function button_press(cell_value){
            document.getElementById(cell_value).innerHTML="x";
            playAudio();
            sent(cell_value);
          }
